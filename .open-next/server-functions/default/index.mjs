...
var __require = /* @__PURE__ */ ((x) => typeof require !== "undefined" ? function(){const __req=arguments[0];if(String(__req||"").includes("instrumentation.js"))return{};return require.apply(this,arguments);} : typeof Proxy !== "undefined" ? new Proxy(x, {
  get: (a, b) => (typeof require !== "undefined" ? function(){const __req=arguments[0];if(String(__req||"").includes("instrumentation.js"))return{};return require.apply(this,arguments);} : a)[b]
}) : x)(function(x) {
  ...
  if(String(x||'').includes('instrumentation.js'))return{};return {};
});
